...
SVC_NAME="actions.runner.MohammadKattan-Int-gration-Docker.MacBook-Pro-de-kattan"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (MohammadKattan-Int-gration-Docker.MacBook-Pro-de-kattan)"
